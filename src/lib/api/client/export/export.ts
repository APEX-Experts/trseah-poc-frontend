...
const exportControllerExportPdf = (
 ...
 options?: SecondParameter<typeof api<Blob>>,) => {
  ...
  return {exportControllerExportTestWord,exportControllerExportWord,exportControllerExportTestPdf,exportControllerExportPdf}};
export type ExportControllerExportTestWordResult = NonNullable<Awaited<ReturnType<ReturnType<typeof getExport>['exportControllerExportTestWord']>>>
export type ExportControllerExportWordResult = NonNullable<Awaited<ReturnType<ReturnType<typeof getExport>['exportControllerExportWord']>>>
export type ExportControllerExportTestPdfResult = NonNullable<Awaited<ReturnType<ReturnType<typeof getExport>['exportControllerExportTestPdf']>>>
export type ExportControllerExportPdfResult = NonNullable<Awaited<ReturnType<ReturnType<typeof getExport>['exportControllerExportPdf']>>>
